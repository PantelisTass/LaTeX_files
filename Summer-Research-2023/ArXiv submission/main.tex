...
%\input{preamble.tex}  % Include the preamble from an external file
% preamble.tex
\usepackage{titlesec}
%\raggedbottom
\usepackage{amsmath}
...
\usepackage{graphicx}
    \graphicspath{ {./images/} }
\usepackage[left=2.5cm, right=2.5cm, top=3cm, bottom=3cm, twoside]{geometry}
\usepackage{float}
...
\centering
\subfloat[$ d=3$]{\label{a}\includegraphics[width=\linewidth]{images/3d-spin-model-neural-net-loss-d=3.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[$ d=4$]{\label{b}\includegraphics[width=\linewidth]{images/3d-spin-model-neural-net-loss-d=4.png}}
\end{minipage}\par\medskip
\centering
\subfloat[$ d=5$]{\label{c}\includegraphics[width=0.55\linewidth]{images/3d-spin-model-neural-net-loss-d=5.png}}
...
\begin{minipage}{.5\linewidth}
\centering
\subfloat[$ d=3$ (Hom MF SGLD)]{\label{a}\includegraphics[width=\linewidth]{images/3d-spin-model-neural-net-plot-d=3.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[$ d=4$ (MaSS)]{\label{b}\includegraphics[width=\linewidth]{images/3d-spin-model-neural-net-plot-d=4.png}}
\end{minipage}\par\medskip
\centering
\subfloat[$ d=5$ (Mass)]{\label{c}\includegraphics[width=.55\linewidth]{images/3d-spin-model-neural-net-plot-d=5.png}}
