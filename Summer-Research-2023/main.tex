...
\begin{table}[H]
\centering
\begin{tabular}{|p{7cm}|p{7cm}|} % Adjust column widths as needed
\hline
...
\begin{figure}\centering
\subfloat[legend]{\label{a}\includegraphics[width=.5\linewidth]{images/MullerBrown-SGD.png}}\hfill
\subfloat[legend]{\label{b}\includegraphics[width=.5\linewidth]{images/MullerBrown-NesterovSGD.png}}\par 
\subfloat[legend]{\label{c}\includegraphics[width=.5\linewidth]{images/MullerBrown-HomSGLD.png}}\hfill 
\subfloat[legend]{\label{d}\includegraphics[width=.5\linewidth]{images/MullerBrown-MaSS.png}}
\caption{my fig}
\label{fig}
\end{figure}
...
\subfloat[legend]{\label{c}\vspace{-3pt}\includegraphics[width=.35\linewidth]{images/3d_spin_sphere_plot_d_5.png}}
\caption{my fig}
\label{fig}
\end{figure}
...
$-40 d^2 = -10^3$ and $40 d^2 = 10^3$.
 ...
 \begin{figure}[H]\centering
\subfloat[legend]{\label{a}\includegraphics[width=.5\linewidth]{images/3d-spin-model-neural-net-loss-d=3.png}}\hfill
\subfloat[legend]{\label{b}\includegraphics[width=.5\linewidth]{images/3d-spin-model-neural-net-loss-d=4.png}}\par 
\subfloat[legend]{\label{c}\includegraphics[width=.5\linewidth]{images/3d-spin-model-neural-net-loss-d=5.png}}
\caption{my fig}
\label{fig}
\end{figure}
