...
\usepackage{tikz}
\usepackage{comment}
\usetikzlibrary{calc, shape, graphs, positioning, backgrounds, decorations.pathmorphing}
\usepackage{forest}
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\graphicspath{ {~/Documents/texfiles/partiiinotes/advanced_proba/images/} }
\usepackage{ifthen}
\usepackage{float}
...
\usepackage{svg}
\svgpath{{~/Documents/texfiles/Summer-Research-2023/images/}}
\usepackage{hyperref}
\usepackage{enumitem}  
\usepackage{pst-node}
