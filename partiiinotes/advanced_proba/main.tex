...
\begin{proof}
    ...
    \parbox[b]{0.4\textwidth}{ % The figure part occupies 40% of the width
        ...
        \begin{tikzpicture}[scale=0.4]  % Adjust scale to fit nicely in the minipage
            ...
            \filldraw[black] (25:3) circle (2pt); % Point in the annulus
            \node at (25:3.3) {$x$};  % Label for point x
...
\mymark{Lecture 21} hello world continue here
